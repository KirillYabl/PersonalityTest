...
async def read_result(request: Request, quiz_result_uuid: UUID) -> HTMLResponse:
    return templates.TemplateResponse(
        "result.html", {"request": request, "quiz_uuid": settings.QUIZ_UUID, "quiz_result_uuid": quiz_result_uuid}
    )
